...
#  """the process for adding mask to micro-expression sequence"""
# 1. read sequance from orignal dir;
# 2. choose one mask for each sequece;
# 3. detect landmark of each img in each sequance, add mask to the face;
